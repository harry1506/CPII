...
% [ Aneu , P ] = doPpq( A, p, q )
%   Aneu = P' A P 
% this function is used to diagonalize the matrix A in the
% p-q-plane. (p has to be smaller than q!)
% next to the rotated matrix A the rotation matrx P is returned  
...
if ~(p<q), error('p muss kleiner q sein!'); end
